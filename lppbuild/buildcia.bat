...
bannertool makebanner -i ..\buildres\banner.png -a ..\buildres\audio.wav -o res\banner.bin
echo Creating icon from file...
bannertool makesmdh -s "%shortdesc%" -l "%longdesc%" -p "%appauthor%" -i ..\buildres\icon.png -o res\icon.bin
